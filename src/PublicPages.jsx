...
const privacySections = [
  ...
  ['share','4. Who receives information',<><p>We do not sell personal information. We disclose only what is necessary to Supabase for database and private file storage, Vercel for hosting, Resend for transactional email, delivery providers for fulfillment, and advisers or authorities when legally required.</p><p>Some providers may process information outside the Philippines. We take reasonable steps to require appropriate protection from processors.</p></>],
  ...
  ['security','7. Security',<p>We use reasonable organizational and technical safeguards, including restricted administrative access and private storage for payment receipts. No online service can guarantee absolute security. We will provide legally required breach notices when applicable.</p>],
...
const termsSections = [
  ...
  ['delivery','4. Preparation and delivery',<><p>Fulfillment begins after payment approval. Delivery timing may vary by location, availability, couriers, weather, and events beyond reasonable control. Dates are estimates unless expressly agreed otherwise.</p><p>You are responsible for providing a complete and reachable delivery address and contact number.</p></>],
  ...
  ['profiles','6. Managed profiles and customer content',<><p>Tappy may create and administer a public managed profile from information you provide. You can request reasonable corrections or updates. Administrative access is not provided unless expressly offered.</p><p>You retain rights in your materials and give Tappy limited permission to host, format, and display them. You confirm submitted content is accurate, lawful, and yours to use.</p></>],
