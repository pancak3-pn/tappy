...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    setMessageDraft((current) => ({
      ...current,
      orderId: selectedThread.order_id || current.orderId,
      subject: current.subject || `Re: ${selectedThread.subject}`,
    }))
