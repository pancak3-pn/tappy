...
const emptyPage = { displayName:'', headline:'', bio:'', photoUrl:'', email:'', phone:'', location:'', accent:'forest', backgroundTexture:'clean', template:'classic', status:'draft', orderId:'', internalNotes:'', links:[{ type:'website', label:'Website', url:'' }, { type:'instagram', label:'Instagram', url:'' }, { type:'linkedin', label:'LinkedIn', url:'' }] }
const pageLinkTypes = [
...
const pageToForm = (page) => ({ displayName:page.display_name || '', headline:page.headline || '', bio:page.bio || '', photoUrl:page.photo_url || '', email:page.email || '', phone:page.phone || '', location:page.location || '', accent:page.accent || 'forest', backgroundTexture:page.background_texture || 'clean', template:page.template || 'classic', status:page.status || 'draft', orderId:page.order_id || '', internalNotes:page.internal_notes || '', links:[...(page.links || []), ...defaultPageLinks()].slice(0,3) })
  ...
  return <main className="admin-page">
    ...
    <div className="admin-shell">
      ...
      {adminView === 'pages' && <section className="admin-pages-workspace">
        ...
        </div><div className="admin-page-preview"><span>Live preview</span><ManagedProfileCard page={pageForm} preview/></div></div></form>
      </section>}
