...
create table if not exists public.tappy_pages (
  ...
  background_texture text not null default 'clean' check (background_texture in ('clean', 'linen', 'silver', 'forest-grain', 'blueprint', 'minimal-gradient', 'geometric-flow', 'soft-waves', 'tech-circuit', 'dark-texture')),
